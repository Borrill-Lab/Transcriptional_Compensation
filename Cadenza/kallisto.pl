...
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/kallisto/";

### lists of samples (text file containing directory/subdirectory with .fastq.gz to align):
my $input_for_kallisto = "/jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/raw_data/all_reads/input_for_kallisto.txt";
...
#SBATCH -c 8
#SBATCH --mem=30000
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/kallisto/slurm_output/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/kallisto/slurm_output/%x.%N.%j.err
