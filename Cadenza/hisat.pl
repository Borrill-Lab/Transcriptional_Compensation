...
my $read_path_triticum = "/jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/trim/";
my $ref = "$path/161010_Chinese_Spring_v1.0_pseudomolecules_parts";
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/hisat/";

### lists of samples (text file containing directory/subdirectory with .fastq.gz - text file should be in $input_list_dir):
my $input_list_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/trim/";
my $input_for_hisat = "/jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/trim/input_for_hisat.txt";
...
#SBATCH --mem=120000
#SBATCH -J hisat2
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/hisat/slurm_output/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/hisat/slurm_output/%x.%N.%j.err
SLURM
