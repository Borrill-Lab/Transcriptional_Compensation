...
grep stop_gained variant_effect_output_all_chromosomes.vcf > /jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/variant_effects_filtering/variant_effect_output_PTC.txt
