...
my $input_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/hisat";
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/freebayes";
...
#SBATCH -c 4
#SBATCH --mem=100000
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/freebayes/slurm_output/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Delfi/X201SC22040269-Z01-F001/freebayes/slurm_output/%x.%N.%j.err
SLURM
