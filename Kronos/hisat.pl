...
my $path = '/jic/scratch/groups/Philippa-Borrill/References/iwgsc_ref_seq_1.1';
my $read_path_triticum = "/jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/trim/";
my $ref = "$path/161010_Chinese_Spring_v1.0_pseudomolecules_parts";
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/hisat/";

### lists of samples (text file containing directory/subdirectory with .fastq.gz to map - text file should be in $input_list_dir):
my $input_list_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/trim/";
my $input_for_hisat = "/jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/trim/input_for_hisat.txt";
...
#SBATCH --mem=120000
#SBATCH -J hisat2
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/hisat/slurm_output/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/hisat/slurm_output/%x.%N.%j.err
SLURM
