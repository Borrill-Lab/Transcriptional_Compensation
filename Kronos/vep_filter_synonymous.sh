...
grep synonymous_variant variant_effect_output_all_chromosomes.vcf > /jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/variant_effects_filtering/variant_effect_output_synonymous.txt
