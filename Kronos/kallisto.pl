...
# script obtained from Philippa.borrill, modified by Delfi Dorussen
#
...
my $path = '/jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/Reference';
...
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/kallisto_noD/";

### lists of samples (text file containing directory/subdirectory with .fastq.gz to align):
my $input_for_kallisto = "/jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/01.RawData/input_for_kallisto.txt";
...
#SBATCH -c 8
#SBATCH --mem=30000
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/kallisto_noD/slurm_output/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/kallisto_noD/slurm_output/%x.%N.%j.err
