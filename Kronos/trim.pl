...
my $read_path_triticum = "/jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/01.RawData/";
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/trim/";

### lists of samples (text file containing directory/subdirectory with .fastq.gz to trim - text file must be in $input_list_dir):
my $input_list_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/01.RawData/";
my $input_for_trim = "/jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/01.RawData/input_for_kallisto.txt";
...
#SBATCH --mem=120000
#SBATCH -J trim
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/01.RawData/trim/slurm_output/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/01.RawData/trim/slurm_output/%x.%N.%j.err
SLURM
 ...
 my $tmp_file = "$output_dir/tmp/trim.$sample";
  ...
  print SLURM "source package 50fcf79b-73a3-4f94-9553-5ed917823423\n";
	...
	print SLURM "trimmomatic PE -phred33 -threads 4 $f1 $f2 $output_dir/$sample"."_1.paired.fq.gz $output_dir/$sample"."_1.unpaired.fq.gz $output_dir/$sample"."_2.paired.fq.gz $output_dir/$sample"."_2.unpaired.fq.gz  ILLUMINACLIP:$adapter_dir/TruSeq3-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:80\n";
