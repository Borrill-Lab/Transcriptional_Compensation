...
my $input_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/hisat";
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/freebayes";
...
#SBATCH -c 4
#SBATCH --mem=100000
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/freebayes/slurm_output/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Delfi/Kronos_TA/X204SC24093218-Z01-F003/freebayes/slurm_output/%x.%N.%j.err
SLURM
