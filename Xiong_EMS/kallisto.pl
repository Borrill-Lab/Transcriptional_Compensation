...
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/Xiong_data/kallisto/";

### lists of samples (text file containing directory/subdirectory with .fastq.gz to align):
my $input_for_kallisto = "/jic/scratch/groups/Philippa-Borrill/Delfi/Xiong_data/raw_data/input_for_kallisto.txt";
...
#SBATCH -c 8
#SBATCH --mem=30000
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Delfi/Xiong_data/kallisto/slurm_output/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Delfi/Xiong_data/kallisto/slurm_output/%x.%N.%j.err
