...
my $read_path_triticum = "/jic/scratch/groups/Philippa-Borrill/Delfi/Xiong_data/raw_data/";
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/Xiong_data/trim/";

### lists of samples (text file containing directory/subdirectory with .fastq.gz to trim - text file must be in $input_list_dir):
my $input_list_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/Xiong_data/raw_data/";
my $input_for_trim = "/jic/scratch/groups/Philippa-Borrill/Delfi/Xiong_data/raw_data/input_for_kallisto.txt";
...
#SBATCH --mem=120000
#SBATCH -J trim
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Delfi/Xiong_data/trim/slurm_output/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Delfi/Xiong_data/trim/slurm_output/%x.%N.%j.err
SLURM
