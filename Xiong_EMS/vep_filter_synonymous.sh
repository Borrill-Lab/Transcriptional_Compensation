...
grep synonymous_variant variant_effect_output_all_chromosomes.vcf > /jic/scratch/groups/Philippa-Borrill/Delfi/Xiong_data/variant_effects_filtering/variant_effect_output_synonymous.txt
